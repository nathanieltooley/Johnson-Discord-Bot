...
class Gamer(commands.Cog):
    ...
    def create_user_stats(member: discord.Member, server: discord.Guild):
        ...
        embed = messaging.create_message_embed(title=f"{username}'s Stats",
    ...
    async def slur_check(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = messaging.create_message_embed(title=f"{user.nick}'s Racist Resume",
    ...
    async def view_gamer_boards(self, interaction: discord.Interaction, sort: str = "money"):
        ...
        if sort == "money":
            ...
            await messaging.respond_embed(interaction, code_block=f"ERROR: {sort} is not a valid field",
        ...
        embed = messaging.create_message_embed(title=f"{embed_title} Gamers",
    ...
    async def give_money(self, interaction: discord.Interaction, receiver: discord.Member, money: int):
        if interaction.user == receiver:
            await messaging.respond_embed(interaction, code_block="You can't send yourself money",
                                                   color=discord.Color.red())
            return
        ...
        if not transact:
            await messaging.respond_embed(interaction, title="Transaction Failed",
